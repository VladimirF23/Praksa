...
  // Local state for modals/forms (Unchanged)
...
  // --- Handlers for BATTERY Functionality (MODIFIED) ---
...
        ...prev, 
        [name]: numericFields.includes(name) ? parseFloat(value) : value // UPDATED LOGIC
    }));
  };
...
    try {
      // 1. API call: Expect the backend to return the newly added battery object
      const newBattery = await addBatteryApi(newBatteryForm);
      
      // 2. State Update: Dispatch the new battery object to the dedicated reducer
      if (newBattery) {
